"use strict";
self["webpackHotUpdate_coral_xyz_app_extension"]("background",{
...
/***/ "../background/dist/esm/backend/ethereum-connection.js":
/*!*************************************************************!*\
  !*** ../background/dist/esm/backend/ethereum-connection.js ***!
  \*************************************************************/
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ETHEREUM_FEE_DATA_REFRESH_INTERVAL": function() { return /* binding */ ETHEREUM_FEE_DATA_REFRESH_INTERVAL; },
/* harmony export */   "ETHEREUM_TOKENS_REFRESH_INTERVAL": function() { return /* binding */ ETHEREUM_TOKENS_REFRESH_INTERVAL; },
/* harmony export */   "EthereumConnectionBackend": function() { return /* binding */ EthereumConnectionBackend; },
...
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ethers */ "../../node_modules/@ethersproject/providers/lib.esm/index.js");
...
const logger = (0,_coral_xyz_common__WEBPACK_IMPORTED_MODULE_0__.getLogger)("ethereum-connection-backend");
...
class EthereumConnectionBackend {
    start() {
    ...
    //
    setupEventListeners() {
        this.events.addListener(_coral_xyz_common__WEBPACK_IMPORTED_MODULE_0__.BACKEND_EVENT, (notif)=>{
            logger.debug(`received notification: ${notif.name}`, notif);
            switch(notif.name){
                case _coral_xyz_common__WEBPACK_IMPORTED_MODULE_0__.NOTIFICATION_KEYRING_STORE_CREATED:
                    handleKeyringStoreCreated(notif);
                    break;
                case _coral_xyz_common__WEBPACK_IMPORTED_MODULE_0__.NOTIFICATION_KEYRING_STORE_UNLOCKED:
                    handleKeyringStoreUnlocked(notif);
                    break;
                case _coral_xyz_common__WEBPACK_IMPORTED_MODULE_0__.NOTIFICATION_KEYRING_STORE_LOCKED:
                    handleKeyringStoreLocked(notif);
                    break;
                case _coral_xyz_common__WEBPACK_IMPORTED_MODULE_0__.NOTIFICATION_ETHEREUM_ACTIVE_WALLET_UPDATED:
                    handleActiveWalletUpdated(notif);
                    break;
                case _coral_xyz_common__WEBPACK_IMPORTED_MODULE_0__.NOTIFICATION_ETHEREUM_CONNECTION_URL_UPDATED:
                    handleConnectionUrlUpdated(notif);
                    break;
                case _coral_xyz_common__WEBPACK_IMPORTED_MODULE_0__.NOTIFICATION_ETHEREUM_CHAIN_ID_UPDATED:
                    handleChainIdUpdated(notif);
                    break;
                case _coral_xyz_common__WEBPACK_IMPORTED_MODULE_0__.NOTIFICATION_BLOCKCHAIN_ENABLED:
                    handleBlockchainEnabled(notif);
                    break;
                case _coral_xyz_common__WEBPACK_IMPORTED_MODULE_0__.NOTIFICATION_BLOCKCHAIN_DISABLED:
        ...
        const handleKeyringStoreUnlocked = async (notif)=>{
            ...
            this.provider = new ethers__WEBPACK_IMPORTED_MODULE_1__.JsonRpcProvider(ethereumConnectionUrl);
            this.url = ethereumConnectionUrl;
            this.chainId = ethereumChainId;
            const activeWallet = blockchainActiveWallets[_coral_xyz_common__WEBPACK_IMPORTED_MODULE_0__.Blockchain.ETHEREUM];
            if (activeWallet) {
        ...
        const handleConnectionUrlUpdated = (notif)=>{
            ...
            this.provider = new ethers__WEBPACK_IMPORTED_MODULE_1__.JsonRpcProvider(connectionUrl);
            this.url = connectionUrl;
        };
        const handleChainIdUpdated = (notif)=>{
            const { chainId  } = notif.data;
            this.provider = new ethers__WEBPACK_IMPORTED_MODULE_1__.JsonRpcProvider(this.url, parseInt(chainId));
            this.chainId = chainId;
        };
        const handleBlockchainEnabled = (notif)=>{
            const { blockchain , activeWallet  } = notif.data;
            if (blockchain === _coral_xyz_common__WEBPACK_IMPORTED_MODULE_0__.Blockchain.ETHEREUM) {
                // Start polling if Ethereum was enabled in wallet settings
                this.startPolling(activeWallet);
            }
        };
        const handleBlockchainDisabled = (notif)=>{
    ...
    async startPolling(activeWallet) {
        this.pollIntervals.push(setInterval(async ()=>{
            ...
            const data = await (0,_coral_xyz_common__WEBPACK_IMPORTED_MODULE_0__.fetchEthereumBalances)(this.provider, activeWallet);
            ...
            this.events.emit(_coral_xyz_common__WEBPACK_IMPORTED_MODULE_0__.BACKEND_EVENT, {
                name: _coral_xyz_common__WEBPACK_IMPORTED_MODULE_0__.NOTIFICATION_ETHEREUM_TOKENS_DID_UPDATE,
                data: {
        ...
        this.pollIntervals.push(setInterval(async ()=>{
            ...
            this.events.emit(_coral_xyz_common__WEBPACK_IMPORTED_MODULE_0__.BACKEND_EVENT, {
                name: _coral_xyz_common__WEBPACK_IMPORTED_MODULE_0__.NOTIFICATION_ETHEREUM_FEE_DATA_DID_UPDATE,
                data: {
                    feeData
                }
            });
...
//# sourceMappingURL=background.4467845fb531d4859bbd.hot-update.js.map